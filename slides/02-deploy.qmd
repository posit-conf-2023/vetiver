...
v <- vetiver_model(inspect_fit, "inspect-results-rstats")
board <- board_connect()
...
v = VetiverModel(inspection_fit, "inspect-results-python", ptype_data = X_train)
...
```{r}
#| eval: false
vetiver_deploy_rsconnect(board, "user.name/inspection-results-rstats")
```
...
vetiver.deploy_rsconnect(
    ...
    board = board,
    pin_name = "user.name/inspection-results-python",
)
```
