...
inspection_rec <- 
  recipe(facility_type + risk + total_violations + inspection_date, 
         data = inspect_train) |> 
  step_date(features = c("month", "year"), keep_original_cols = FALSE)
...
## Your turn 🏺 {transition="slide-in", auto-animate=TRUE}
