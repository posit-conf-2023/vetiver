...
- For R, set up publishing from RStudio: <https://docs.posit.co/connect/user/publishing/#publishing-general>
...
- Set up Connect publishing from RStudio: <https://docs.posit.co/connect/user/publishing/#publishing-general>
- Create an API key for our Posit Connect server, and save it on Workbench in your working directory (in `.Renviron` for R or `.env` for Python).

Create a new vetiver model object that includes your username, and pin this vetiver model to our Connect instance.
