...
:::notes
# TODO: not really relevant, but not sure if we want to bring up this point in a different way
...
inspection |>
  ggplot(aes(inspection_date, total_violations, color = results)) +
