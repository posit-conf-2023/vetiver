...
```{python}
## TODO for Isabel: show output file (hard-coded like R is fine)
vetiver.write_app(board, "inspection-result-python")
```
...
```{python}
## TODO for Isabel: show original app.py
```
...
```{python}
## TODO for Isabel: show new updated app.py with additional endpoint
```
