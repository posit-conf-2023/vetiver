...
## Connect model metrics to organizational outcomes
...
- There isn't always a 1-on-1 mapping 😔
...
Let's say that the most important organizational outcome for the Chicago Department of Public Health is how many establishments were predicted to pass their inspection but _failed_.

Depending on whether "pass" or "fail" is the event level of interest, this is either the false positive rate or false negative rate.
