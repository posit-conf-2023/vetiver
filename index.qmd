...
- To use Python: Install recent versions of Python and [Visual Studio Code](https://code.visualstudio.com/download), along with the packages outlined in our [`requirements.txt`](https://github.com/posit-conf-2023/vetiver/blob/main/requirements.txt)
- Optionally, install [Docker](https://docs.docker.com/get-docker/)
